            ...
            <div class="flex items-center justify-between">
                ...
                <div class="relative inline-block text-gray-200">
                    ...
                    <ul id="profileDropdown"
                        ...
                        <li><a href="{{route('admin.password.update')}}"
                                ...
                                <ul class="ml-4 mt-2 space-y-2">
                                    <li class="my-3">
                                        <a href="{{route('admin.all.users')}}"
                                            class="flex items-center text-gray-300 hover:">
                                           All User
                                        </a>
                                    </li>   
                                </ul>
                        ...
                        <li class="my-3">
                            ...
                            <div x-data="{ open: false }">
                                ...
                                <ul class="ml-4 mt-2 space-y-2">
                                    ...
                                    <li><a href="{{route('admin.approved.loan.application')}}" class="text-gray-300 hover:text-white">View Approved Application</a></li>
                                </ul>
                            </div>
                        </li>
                        <!-- Add More Items Here -->
