        ...
        <header class="bg-gradient-to-r from-blue-500 to-indigo-700 px-6 py-3">
            <div class="flex items-center justify-between">
                ...
                <div class="relative inline-block text-gray-200">
                    ...
                    <ul id="profileDropdown" class=" mt-2 py-2 w-32 bg-white border rounded-lg shadow-lg absolute right-0" x-cloak>
                        ...
                        <form action="{{route('logout')}}" method="post">
                            @csrf
                        <li><a href="{{route('logout')}}" onclick="event.preventDefault(); this.closest('form').submit();" class="block px-4 py-2 text-gray-800 hover:bg-gray-200">Logout</a></li>
        ...
        <div class="flex-1">
            <div class="flex h-full">
                ...
                <div class="bg-gray-800 text-white w-64 px-6 py-8">
                    ...
                    <ul class="mt-8">
                        <li class="my-3">
                            <a href="#" class="flex items-center text-gray-300 hover:">
                                Dashboard
                            </a>
                        </li>
                        <li class="my-3">
                        ...
                        <li class="my-3">
                            <div x-data="{ open: false }">
                                <button @click="open = !open" class="flex items-center">
                                    Products
                                    <svg x-show="!open" class="ml auto h-5 w-5" fill="none" stroke="current">
                                        <path stoke-linecap="round" stroke-linejoin="round"></path>
                                    </svg>
                                    <svg x-show="open" class="ml auto h-5 w-5" fill="none" stroke="current">
                                        <path stoke-linecap="round" stroke-linejoin="round"></path>
                                    </svg>
